...
!(function(e, t) {
  ...
  function s(s, a) {
    var r = [],
      n = 0;
    if (s && !a && _instanceof(s, i)) return s;
    if (s)
      if ("string" == typeof s) {
        var o,
          l,
    ...
    o = {
      touch:
        ...
        !!(
          ...
          "ontouchstart" in t ||
          (t.DocumentTouch && _instanceof(e, t.DocumentTouch))
        ),
      pointerEvents:
        !!t.PointerEvent &&
      ...
      setTranslate: function setTranslate(e, t) {
        ...
        if (Array.isArray(r))
          for (var o = 0; o < r.length; o += 1) {
            r[o] !== t && _instanceof(r[o], W) && n(r[o]);
          }
        else _instanceof(r, W) && t !== r && n(r);
      },
      setTransition: function setTransition(e, t) {
        var i,
          s = this,
        ...
        if (Array.isArray(a))
          for (i = 0; i < a.length; i += 1) {
            a[i] !== t && _instanceof(a[i], W) && r(a[i]);
          }
        else _instanceof(a, W) && t !== a && r(a);
      }
    },
    he = {
