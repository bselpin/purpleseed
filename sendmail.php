...
if(!$name)message("이름을 입력해 주세요");
if(!$corporation)message("기업/기관명을 입력해 주세요");
if(!$hp)message("연락처를 입력해 주세요");
if(!$frommail)message("메일을 입력해 주세요");
if(!$subject)message("내용을 입력해 주세요");
